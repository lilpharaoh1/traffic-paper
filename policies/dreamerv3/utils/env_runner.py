...
class DreamerV3EnvRunner(EnvRunner):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # EMRAN had to add this to make it compatible with old training proceedure
    ...
    def _sample_timesteps(
        ...
        if force_reset or self._needs_initial_reset:
            print("DremaerV3EnvRunner._sample_timesteps -> before self.env.reset()")
    ...
    def _sample_episodes(
        ...
        print("DremaerV3EnvRunner._sample_episodes -> before self.env.reset()")
        obs, _ = self.env.reset()
...
class OneHot(gym.ObservationWrapper):
    ...
    def reset(self, **kwargs):
        print("DremaerV3EnvRunner/oneHot.reset -> before self.env.reset()") 
