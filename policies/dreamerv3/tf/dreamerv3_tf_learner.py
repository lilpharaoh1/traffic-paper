...
from policies.dreamerv3.dreamerv3 import DreamerV3TrafficConfig
from policies.dreamerv3.dreamerv3_learner import DreamerV3Learner
...
class DreamerV3TfLearner(DreamerV3Learner, TfLearner):
    ...
    def configure_optimizers_for_module(
        self, module_id: ModuleID, config: DreamerV3TrafficConfig = None, hps=None
    ):
    ...
    def _compute_world_model_prediction_losses(
        ...
        *,
        ...
        Args:
            config: The DreamerV3TrafficConfig to use.
    ...
    def _compute_world_model_dynamics_and_representation_loss(
        self, *, config: DreamerV3TrafficConfig, fwd_out: Dict[str, Any]
