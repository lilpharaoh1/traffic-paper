...
from policies.dreamerv3.dreamerv3_catalog import DreamerV3Catalog
from policies.dreamerv3.utils import do_symlog_obs
from policies.dreamerv3.utils.env_runner import DreamerV3EnvRunner
from policies.dreamerv3.utils.summaries import (
...
class DreamerV3TrafficConfig(AlgorithmConfig):
    """Defines a configuration class from which a DreamerV3 can be built.

    .. testcode::

        from policies.dreamerv3 import DreamerV3TrafficConfig
        config = (
    ...
    def __init__(self, algo_class=None):
        """Initializes a DreamerV3TrafficConfig instance."""
        super().__init__(algo_class=algo_class or DreamerV3Traffic)
        ...
        **kwargs,
        ...
        Args:
            model_size: The main switch for adjusting the overall model size. See [1]
                ...
                implementation). See policies.dreamerv3.utils.
        ...
        if use_curiosity is not NotProvided:
            raise ValueError(
                "`DreamerV3TrafficConfig.curiosity` is not fully supported and tested yet! "
    ...
    def get_default_learner_class(self):
        if self.framework_str == "tf2":
            from policies.dreamerv3.tf.dreamerv3_tf_learner import (
                DreamerV3TfLearner,
            )
    ...
    def get_default_rl_module_spec(self) -> SingleAgentRLModuleSpec:
        if self.framework_str == "tf2":
            from policies.dreamerv3.tf.dreamerv3_tf_rl_module import (
                DreamerV3TfRLModule,
            )
...
class DreamerV3Traffic(Algorithm):
