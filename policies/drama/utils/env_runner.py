...
class DramaEnvRunner(EnvRunner):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initializes a DramaEnvRunner instance.
        ...
        if self.config.share_module_between_env_runner_and_learner:
            # Drama Algorithm will set this to the local Learner's module.
            self.module = None
        # Create our own instance of a DramaRLModule (which then needs to be
        # weight-synched each iteration).
        else:
            # TODO (sven): Drama is currently single-agent only.
