"""
This file holds framework-agnostic components for Drama's RLModule.
"""
...
from policies.drama.tf.models.drama_model import DramaModel
...
@ExperimentalAPI
class DramaRLModule(RLModule, abc.ABC):
    @override(RLModule)
    def setup(self):
        ...
        # Build the final drama model (containing the world model).
        ...
        # Perform a test `call()` to force building the drama model's variables.
        test_obs = np.tile(
    ...
    def get_initial_state(self) -> NestedDict:
        # Use `DramaModel`'s `get_initial_state` method.
        return self.drama_model.get_initial_state()
