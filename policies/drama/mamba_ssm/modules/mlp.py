...
class MLP(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        self.fc1 = tf.keras.layers.Dense(fc1_hidden_features, use_bias=bias, kernel_initializer='glorot_uniform', **factory_kwargs)
        self.fc2 = tf.keras.layers.Dense(out_features, use_bias=bias, kernel_initializer='glorot_uniform', **factory_kwargs)
        ...
        if self.use_gate_mlp:
            assert self.activation == tf.nn.gelu, (
