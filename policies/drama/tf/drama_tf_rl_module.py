...
from policies.drama.drama_rl_module import DramaRLModule
...
class DramaTfRLModule(TfRLModule, DramaRLModule):
    """The tf-specific RLModule class for Drama.
    ...
    def _forward_inference(self, batch: NestedDict) -> Dict[str, Any]:
        ...
        actions, next_state = self.drama_model.forward_inference(
    ...
    def _forward_exploration(self, batch: NestedDict) -> Dict[str, Any]:
        ...
        actions, next_state = self.drama_model.forward_exploration(
            observations=batch[Columns.OBS],
            previous_states=batch[Columns.STATE_IN],
            is_first=batch["is_first"],
        )
    ...
    def _forward_train(self, batch: NestedDict):
        ...
        return self.drama_model.forward_train(
            observations=batch[Columns.OBS],
