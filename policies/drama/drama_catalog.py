...
class DramaCatalog(Catalog):
    """The Catalog class used to build all the models needed for Drama training."""
    ...
    def __init__(
        ...
        """Initializes a DramaCatalog instance.
        ...
        #  and even try replacing all current Drama model components with
        #  our default primitives. But for now, we'll construct the DramaModel
    ...
    def build_encoder(self, framework: str) -> Encoder:
        ...
        if self.is_img_space:
            from policies.drama.tf.models.components.cnn_atari import (
                CNNAtari,
            )
    ...
    def build_decoder(self, framework: str) -> Model:
        ...
        if self.is_img_space:
            from policies.drama.tf.models.components import (
